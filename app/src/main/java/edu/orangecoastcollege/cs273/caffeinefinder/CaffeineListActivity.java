...
public class CaffeineListActivity extends AppCompatActivity
        implements OnMapReadyCallback, GoogleApiClient.ConnectionCallback,
    ...
    public void onConnected(@Nullable Bundle bundle){
        if(ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION)
                ...
                android.Manifest.permission.ACESS_COARSE_LOCATION)
                != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACESS_FINE_LOCATION}, FINE_LOCATION_REQUEST_CODE);
        }
    ...
    private void handleNewLocation(Location newLocation){
        // Clear the map first:
        mMap.clear();
        // Let's change the value of my location to newLocation
